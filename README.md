...
git clone https://github.com/NENO900/GENERAL.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf GENERAL && rm -rf .telegram-cli && git clone https://github.com/NENO900/GENERAL.git && cd GENERAL && ./launch.sh install && ./launch.sh
~~~~~
